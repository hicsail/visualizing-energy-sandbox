                                        ...
                                        onResizeStop={(e) => {
                                            ...
                                            try {
                                                Transforms.setNodes(
                                                    editor,
                                                    {
                                                        height: leftRef.current
                                                            .state.height,
                                                        width: leftRef.current
                                                            .state.width,
                                                    },
                                                    { at: path }
                                                );
                                        ...
                                        onResizeStop={(e) => {
                                            ...
                                            try {
                                                Transforms.setNodes(
                                                    editor,
                                                    {
                                                        height: rightRef.current
                                                            .state.height,
                                                        width: rightRef.current
                                                            .state.width,
                                                    },
                                                    { at: path }
                                                );
                            ...
                            onResizeStop={(e) => {
                                ...
                                try {
                                    Transforms.setNodes(
                                        editor,
                                        {
                                            height: ElementRef.current.state
                                                .height,
                                            width: ElementRef.current.state
                                                .width,
                                        },
                                        { at: path }
                                    );
                    ...
                    >
                        {isAdmin ? (
                            <ResizableBox
                                ...
                                onResizeStop={(e) => {
                                    setiFrameHeight(
                                        ElementRef.current.state.height
                                    );
                                    setiFrameWidth(
                                        ElementRef.current.state.width
                                    );
                                    console.log(iFrameHeight, iFrameWidth);
                                    setResizeInProgress(false);
                                    // try {
                                ...
                                >
                                    {isAdmin ? (
                                        <ResizableBox
                                            ...
                                            onResizeStop={(e) => {
                                                setiFrameHeight(
                                                    rightRef.current.state
                                                        .height
                                                );
                                                setiFrameWidth(
                                                    rightRef.current.state.width
                                                );
                                                console.log(
                                                    iFrameHeight,
                                                    iFrameWidth
